    ...
    export default class UserList extends Mixins(Base, MessagesMixin, TableConfig) {
        ...
        changePage(nextPage) {
            ...
            history.replaceState('', '', this.makeQueryString(this.$refs.vuetable.currentPage,
                this.table.pagination.per_page, this.keywords, this.sort, this.role ? this.role.name : ''));
        }
        ...
        search() {
            ...
            history.replaceState('', '', this.makeQueryString(1, this.table.pagination.per_page,
