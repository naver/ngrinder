 ...
 * 
 * Actually this class is used for grinder agent's javaagent. grinder agent is run with java agent name
 * grinder-dcr-agent-**.jar but grinder agent mistakenly takes the javadoc and sources file as javaagent . So.. This
 * class deletes out the sources and javadoc files of grinder-dcr-agent in class path.
 * 
 * @author JunHo Yoon
 */
@Component
