...
package org.hibernate.dialect.cubrid;
...
public class CUBRIDDialect extends Dialect {
	public CUBRIDDialect() {
		...
		registerFunction("character_length", new StandardSQLFunction("character_length",
		...
		registerFunction("sys_timestamp", new NoArgSQLFunction("sys_timestamp", StandardBasicTypes.TIMESTAMP,
						false));
		...
		registerFunction("localtimestamp", new NoArgSQLFunction("localtimestamp",
						StandardBasicTypes.TIMESTAMP, false));
		...
		registerFunction("from_unixtime", new StandardSQLFunction("from_unixtime",
	...
	/**
	 * The character specific to this dialect used to close a quoted identifier. CUBRID supports
	 * square brackets (MSSQL style), backticks (MySQL style), as well as double quotes (Oracle
	 * style).
	 * 
