...
public class KotlinScriptEngineService implements ScriptEngineService {
	...
	private final FileExtensionMatcher kotlinScriptFileMatcher = new FileExtensionMatcher(".kts");
	...
	public ScriptEngine createScriptEngine(ScriptLocation script) throws EngineException {
		if (kotlinScriptFileMatcher.accept(script.getFile())) {
			return new KotlinScriptEngine(script);
		}
