...
public interface HttpGet {
	...
	default HttpResponse GET(String uri, Map<String, String> params, Map<String, String> GETers) {
		return GET(uri, convert(params, BasicNameValuePair::new), convert(GETers, BasicHeader::new));
	}
}
