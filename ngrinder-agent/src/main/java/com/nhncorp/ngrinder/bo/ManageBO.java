package com.nhncorp.ngrinder.bo;
...
public class ManageBO {
    /** The Constant LOG. */
    private static final Logger LOG = LoggerFactory.getLogger(ManageBO.class);
    ...
    public void loadCatalinaLogs(String hostKey) throws Exception {
        LOG.info("[ManageBO]:Load catalina log from host:{} ", hostKey);
    ...
    public void loadGrinderLogs(String hostKey, String logPath) throws Exception {
        LOG.info("[ManageBO]:Load Grinder log from host:{}.", hostKey);
