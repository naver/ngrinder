...
public interface OnTestSamplingRunnable extends ExtensionPoint {
	 ...
	 */
	void startSampling(ISingleConsole singleConsole, PerfTest perfTest, IPerfTestService perfTestService);
	 ...
	 */
	void sampling(ISingleConsole singleConsole, PerfTest perfTest, IPerfTestService perfTestService,
	 ...
	 * @param perfTestService	{@link IPerfTestService}
	 */
	void endSampling(ISingleConsole singleConsole, PerfTest perfTest, IPerfTestService perfTestService);
