...
public interface OnTestLifeCycleRunnable extends ExtensionPoint {
	 ...
	 */
	void start(PerfTest perfTest, IPerfTestService perfTestService, String version);
	 ...
	 * @param version			ngrinder version
	 */
	void finish(PerfTest perfTest, String stopReason, IPerfTestService perfTestService, String version);
}
