...
public interface IPerfTestService {
	 ...
	 */
	PerfTest getOne(User user, Long id);
	 ...
	 */
	List<PerfTest> getAll(Date start, Date end);
	 ...
	 * @return found {@link PerfTest} list
	 */
	List<PerfTest> getAll(Date start, Date end, String region);
	 ...
	 */
	List<PerfTest> getAll(User user, Long[] ids);
	 ...
	 * @return the count
	 */
	long count(User user, Status[] statuses);
	 ...
	 * @return found {@link PerfTest} list.
	 */
	List<PerfTest> getAll(User user, Status[] statuses);
	 ...
	 * @return found {@link PerfTest}, null otherwise
	 */
	PerfTest getOneWithTag(Long testId);
	 ...
	 * @return saved {@link PerfTest}
	 */
	PerfTest markStatusAndProgress(PerfTest perfTest, Status status, String message);
