...
public class JGoogleAnalyticsTracker {
	 ...
	 *            (For ex: "UA-2184000-1")
	 */
	JGoogleAnalyticsTracker(AgentConfig agentConfig, String appName, String googleAnalyticsTrackingCode) {
		this.urlBuildingStrategy = new GoogleAnalyticsV1URLBuildingStrategy(appName, googleAnalyticsTrackingCode);
	}
