...
/**
 * Focus point of the application. It can represent data points like application load, application
 * module load, user actions, error events etc.
 * 
...
public class FocusPoint {
	 ...
	 * 
	 * @param name name
	 * @param parentFocusPoint parent focus point
	 */
